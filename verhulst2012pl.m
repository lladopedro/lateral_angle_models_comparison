function [V,Y,OAE,CF]=verhulst2012pl(sign,fs,fc,spl,varargin)
...
%
%   Url: http://amtoolbox.org/amt-1.6.0/doc/models/verhulst2012.php
...
output=amt_extern_pl('Python','verhulst2012','run_cochlear_model.py',in,out);

% save('/Users/pl0022/Documents/GitRepos/ImageShift/model_comparison_image_shift/amtoolbox-1.6.0/environments/verhulst2012/out/input.mat','in')
% py.sys.path().append('/Users/pl0022/Documents/GitRepos/ImageShift/model_comparison_image_shift/amtoolbox-1.6.0/environments/verhulst2012');
% mdl = py.importlib.import_module('run_cochlear_model');
% disp('Press a key when the cochlear model has ended!')
% pause;
%status = system('python3 /Users/pl0022/Documents/GitRepos/ImageShift/model_comparison_image_shift/amtoolbox-1.6.0/environments/verhulst2012/run_cochlear_model.py');
%p=pyrunfile("/Users/pl0022/Documents/GitRepos/ImageShift/model_comparison_image_shift/amtoolbox-1.6.0/environments/verhulst2012/run_cochlear_model.py");
