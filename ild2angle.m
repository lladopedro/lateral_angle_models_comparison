...
%
%   Url: http://amtoolbox.org/amt-1.6.0/doc/common/itd2angle.php
...
for n = 1:size(ild,2)
    ...
    phi(:,n)=polyval(lookup.p_ild(:,n),ild(:,n),lookup.S_ild{n},lookup.MU_ild(:,n));
end
